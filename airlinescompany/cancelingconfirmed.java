 ...
 * @author ooooo
 */
public class cancelingconfirmed extends javax.swing.JFrame {

    /** Creates new form cancelingconfirmed */
    public cancelingconfirmed() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("your flight has successfuly been cancelled ");

        jLabel7.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 12)); // NOI18N
        jLabel7.setText("whould you like to book another?");

        jButton1.setBackground(new java.awt.Color(54, 33, 89));
        jButton1.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setText("Book another flight");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cancelingconfirmed.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cancelingconfirmed().setVisible(true);
            }
        });
    }
